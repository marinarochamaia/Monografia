...
% ---
\titulo{Estudo do Problema do Roteamento de Veículos com Janela de Tempo por Meio de Computação Evolutiva}
\autor{Marina Rocha Maia}
\local{João Monlevade}
\dia{11}
\mes{2}
\ano{2018} % Indicar apenas o ano da monografia
...
% ---
\orientador{Fernando Bernardes Oliveira}
